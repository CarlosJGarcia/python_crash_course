...
Try languages such as JavaScript, Ruby, C, Java ...
"""
...
print(f"Datos: Número de repositorios Rust en GitHub: {response_dict['total_count']}")
...
print()
print("First 10 Rust Github repositories:")
print()
n = 0
...
# Visualization
title = "Most starred Github Rust repositories"
